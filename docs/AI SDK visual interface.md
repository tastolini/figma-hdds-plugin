...
[Next.js](https://sdk.vercel.ai/cookbook/next)Render Visual Interface in Chat

An interesting consequence of language models that can call [tools](https://sdk.vercel.ai/docs/ai-sdk-core/tools-and-tool-calling) is that this ability can be used to render visual interfaces by streaming React components to the client.

Assistant

:

All good, how may I help you?
